...
Route::get('/LaporanKeuangan/GetLaporanBulanan', [LaporanKeuanganController::class, 'GetLaporanBulanan']);
Route::get('/LaporanKeuangan/GetTotalLaporanBulanan', [LaporanKeuanganController::class, 'GetTotalLaporanBulanan']);
